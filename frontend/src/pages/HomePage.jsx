    ...
    <div className="home-page">
      ...
      <section className="home-hero" aria-labelledby="hero-heading">
        <div className="home-hero__content">
          <div className="home-hero__badge">🌴 Sri Lanka's Premier Travel Platform</div>
        ...
        <div className="home-hero__visual" aria-hidden="true">
          ...
          <div className="home-hero__card home-hero__card--1">
            <span className="home-hero__card-icon">🏛️</span>
        ...
        <div className="home-features__inner">
          ...
          <div className="home-features__grid">
            <article className="home-feature-card">
              <div className="home-feature-card__icon" aria-hidden="true">🗺️</div>
        ...
        <div className="home-footer__inner">
          ...
          <div className="home-footer__col">
            ...
            <ul className="home-footer__contact-list">
              <li>
                <span className="home-footer__contact-icon" aria-hidden="true">✉</span>
