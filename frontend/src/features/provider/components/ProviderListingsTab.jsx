          ...
          <form onSubmit={handleSubmit} className="pd-modal__form" noValidate>
            ...
            {!isHotel && !isRestaurant && (
              <>
                ...
                <div className="pd-grid-2 pd-mt-4">
                  <div className="pd-form-group">
                ...
                <div className="pd-slot-config-box">
                            ...
                            {s.timeSlots ? (
                              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '4px' }}>
                                {s.timeSlots.split(',').map((slot, i) => (
                                  <span key={i} className="pd-tag-pill">
                                    {slot.trim()}
                                  </span>
                                ))}
                              </div>
